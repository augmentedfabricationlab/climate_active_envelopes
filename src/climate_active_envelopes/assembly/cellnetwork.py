...
class CAECellNetwork(CellNetwork):
    ...
    def face_properties(self, cell_network):
        """Calculate the properties of the face in the cell network.
        ...
        Vector
            The direction vector of the horizontal edge.
        """

        # Get the edges of the current face
        face_edges, edge_types = self.select_face_and_get_adjacent_edges(cell_network, face_key)

        vertical_edges = []
        for edge, edge_type in edge_types['vertical']:
        ...
        horizontal_edges = []
        for edge, edge_type in edge_types['horizontal']:
        ...
        #cell_network.face_attribute(cell_network.current_face, 'vertical_edge_length', vertical_edge_length)
        #cell_network.face_attribute(cell_network.current_face, 'direction_vector', direction_vector)

        return vertical_edge_length, direction_vector
